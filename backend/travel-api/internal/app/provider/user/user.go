...
func (s *Storer) QueryAll(ctx context.Context) ([]userUsecase.User, error) {
	ctx, span := web.AddSpan(ctx, "provider.user.query-all")
	defer span.End()
	users := []StorerUser{}
	q := `SELECT * from users;`
...
func (s *Storer) Create(ctx context.Context, u userUsecase.User) error {
	ctx, span := web.AddSpan(ctx, "provider.user.create")
	defer span.End()
	user := StorerUser{
		ID:           u.ID,
		Name:         u.Name,
...
func (s *Storer) QueryByID(ctx context.Context, userID string) (userUsecase.User, error) {
	ctx, span := web.AddSpan(ctx, "provider.user.query-by-id")
	defer span.End()
	user := StorerUser{}
...
func (s *Storer) QueryByEmail(ctx context.Context, email string) (userUsecase.User, error) {
	ctx, span := web.AddSpan(ctx, "provider.user.query-by-email")
	defer span.End()
	user := StorerUser{}
...
func (s *Storer) QueryTokenByEmail(ctx context.Context, email string) (userUsecase.VerifyToken, error) {
	ctx, span := web.AddSpan(ctx, "provider.user.query-token-by-email")
	defer span.End()
	token := StorerToken{}
...
func (s *Storer) Update(ctx context.Context, u userUsecase.User) error {
	ctx, span := web.AddSpan(ctx, "provider.user.update")
	defer span.End()
	user := StorerUser{
		ID:           u.ID,
		Name:         u.Name,
...
func (s *Storer) Verify(ctx context.Context, u userUsecase.User) error {
	ctx, span := web.AddSpan(ctx, "provider.user.verify")
	defer span.End()
	user := StorerUser{
		ID:           u.ID,
		Name:         u.Name,
...
func (s *Storer) Delete(ctx context.Context, u userUsecase.User) error {
	ctx, span := web.AddSpan(ctx, "provider.user.delete")
	defer span.End()
	user := StorerUser{
		ID:           u.ID,
		Name:         u.Name,
...
func (s *Storer) DeleteVerifyTokensByUserID(ctx context.Context, uID string) error {
	ctx, span := web.AddSpan(ctx, "provider.user.delete-verify-tokens-by-user-id")
	defer span.End()
